...
from impact_aware_contact_selection import example_dualCntPntOpt_weird as DualCntPntOpt
...
class PredictionWithTO():
    ...
    def contactSelection(self, initObjPos, initObjVel):

        

        return initIndex, normIndex, normVector, cntPntVector
