...
ROBOT_NAME_SIM = "nextage/ros_pybullet_interface/robot/REND_EFFECTOR_finger"
END_EFFECTOR_TARGET_FRAME_ID_SIM = 'nextage/ros_pybullet_interface/end_effector/target' # listens for end-effector poses on this topic
