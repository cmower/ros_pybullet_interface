...
class Node:
    ...
    def __init__(self):
        ...
        rospy.Timer(rospy.Duration(1.0/rospy.get_param('~hz', 50)), self.main_loop)
    ...
    def main_loop(self, event):
        ...
        # Get force feedback
        f = 0.04*(self.ft_reading - self.zforce_offset)
        print(f"---------forcefeedback: {f:0.4f}")        
        ff = Vector3(x=0, y=0, z=f)
